...
public class SearchPanel extends JPanel implements ActionListener {
	...
	public void createtablemodel()
	{
		...
		if(studentandfacultycombo.getSelectedIndex()==0)
		{
			String defaultquery="select s.courcecode as 'Class' ,s.rollnumber as 'Roll No',concat(s.firstname,' ',s.lastname) as 'Student Name',c.courcename as 'Program Name',concat(c.semoryear,'-',s.semoryear) as 'Sem/Year' from students s left join cources c on s.courcecode=c.courcecode ";
